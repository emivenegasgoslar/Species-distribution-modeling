...
# let's create a raster stack (stack f layers/variables)
# list of files
...
# drill down on where our date lives
...
# create a grid of climate measurments, per occurence point

occEnv <- na.omit(raster::extract(x = currentClimRasterStack, y = occurrenceCoords))

# create a grid of measurements for pseudo absent points 
